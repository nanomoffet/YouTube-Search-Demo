 ...
 */
export class SearchDataSource extends DataSource<SearchResult> {
   ...
   */
  connect(): Observable<SearchResult[]> {
   ...
   */
  private getSortedData(data: SearchResult[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        case 'title':
          return compare(a.snippet.title, b.snippet.title, isAsc);
        default:
          return 0;
      }
    });
